...
class Test_regis(unittest.TestCase):
    ...
    def test_a_success_regis(self):
        ...
        time.sleep(3)
        response_message = browser.find_element(By.XPATH,"/html/body/div[2]/ul[3]/li/div/div/div/div[1]").text
        time.sleep(1)
        response_message2 = browser.find_element(By.XPATH,"/html/body/div[2]/ul[3]/li/div/div/div/div[2]").text

        self.assertEqual(response_message,"Toko berhasil didaftarkan")
        time.sleep(2)
        self.assertEqual(response_message2,"anda dapat menggunakan login sekarang")
        time.sleep(2)
